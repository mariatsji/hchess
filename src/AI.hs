...
focused' e 0                      = [e]
focused' (gh, f, WhiteToPlay) d   = (highest' 10 (fmap evaluate' (positionTree' gh))) >>= (flip focused' (d - 1))
focused' (gh, f, BlackToPlay) d   = (lowest'  10 (fmap evaluate' (positionTree' gh))) >>= (flip focused' (d - 1))
focused' e _                      = [e]
